...
// for multiline comment press ctrl + shift + A
#include <bits/stdc++.h>
using namespace std;
void printName(string name);
void modifyString(string name);
void modifyStringByAddress(string &name);
...
int main()
{
    ...
    // Data types
    // int, char, long, long long, float, double, long double
    // string, getline
    // long double x = 50100488165389.184594734;
    // cout << x << endl;
    // string str;
    // getline(cin, str);
    // cout << str << endl;
    ...
    string newName = "Prashin";
    modifyStringByAddress(newName);
    cout << newName;
    // int arr[] = {43, 34, 56, 78};
...
{
    name[0] = 'T';
    cout << "We have modified the original string!" << endl;
}
void modifyArray(int arr[], int size)
{
    arr[0] = 0;
